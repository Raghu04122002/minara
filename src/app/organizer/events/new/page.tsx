...
export default function OrganizerCreateEventPage() {
    ...
    return (
        <div className="container" style={{ maxWidth: '700px', padding: '2rem' }}>
            ...
            <h1 className="heading" style={{ color: '#0f172a' }}>Create Event</h1>
            ...
            <form onSubmit={handleSubmit}>
                <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', background: 'white', borderRadius: '0.75rem', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px 0 rgb(0 0 0 / 0.1)' }}>
                    <h2 style={{ margin: 0, fontSize: '1rem', fontWeight: 600, borderBottom: '1px solid #e2e8f0', paddingBottom: '0.75rem', color: '#0f172a' }}>Event Details</h2>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '0.75rem', color: '#94a3b8', margin: '0.25rem 0 0' }}>Public URL: /e/{slug || '...'}</p>
                    </div>
                ...
                {eventType === 'ticketed_event' && (
                    <div className="card" style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', background: 'white', borderRadius: '0.75rem', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px 0 rgb(0 0 0 / 0.1)' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e2e8f0', paddingBottom: '0.75rem' }}>
                            <h2 style={{ margin: 0, fontSize: '1rem', fontWeight: 600, color: '#0f172a' }}>Ticket Tiers</h2>
                            <button type="button" onClick={addTier} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', padding: '0.375rem 0.75rem', fontSize: '0.8rem', background: '#f8fafc', color: '#0f172a', border: '1px solid #e2e8f0', borderRadius: '6px', cursor: 'pointer', fontWeight: 600 }}>
                                <Plus size={14} /> Add Tier
                            </button>
                        </div>

                        {tiers.length === 0 && (
                            <p style={{ fontSize: '0.875rem', color: '#94a3b8', textAlign: 'center', padding: '1rem' }}>No ticket tiers yet. Add one to enable paid registration.</p>
                        )}

                        {tiers.map((tier, i) => (
                            <div key={i} style={{ padding: '1rem', background: '#f8fafc', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: '0.75rem', border: '1px solid #e2e8f0' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ fontWeight: 600, fontSize: '0.85rem', color: '#334155' }}>Tier {i + 1}</span>
                ...
                <div style={{ marginTop: '1.5rem', display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
                    <Link href="/organizer/events" className="btn" style={{ background: '#f1f5f9', color: '#475569', fontWeight: 500 }}>Cancel</Link>
                    <button type="submit" className="btn" disabled={loading} style={{ background: '#0f172a', color: 'white', opacity: loading ? 0.6 : 1, fontWeight: 500 }}>
